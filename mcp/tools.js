  ...
  const tools = {
    ...
    yunti_scroll: {
      ...
      notes: [
        ...
        "When before/after positions are comparable, results include moved; no movement returns code=NO_SCROLL_MOVEMENT, ok=false, recoverable=true, edgeHint such as possible-bottom-edge when direction can be inferred, and recoveryHint with nextAction/recommendedTools.",
      ],
      recovery: [
        ...
        "No movement: read recoveryHint and edgeHint, observe again, inspect likely scroll boundaries, try the nearest observed scrollable container uid, or stop repeating the same scroll.",

  ...
  const tools = {
    ...
    yunti_scroll: {
      ...
      notes: [
        ...
        "When before/after positions are comparable, results include moved; no movement returns code=NO_SCROLL_MOVEMENT, ok=false, recoverable=true, and edgeHint such as possible-bottom-edge, possible-top-edge, possible-right-edge, or possible-left-edge when direction can be inferred.",
      ],
      recovery: [
        ...
        "No movement: use edgeHint to inspect likely scroll boundaries, try the nearest observed scrollable container uid, or stop repeating the same scroll.",
      ...
      commonMistakes: [
        ...
        "Do not blindly repeat scroll when moved=false or NO_SCROLL_MOVEMENT appears; read edgeHint, observe, or inspect boundaries first.",
      ],
    },
    yunti_select: {

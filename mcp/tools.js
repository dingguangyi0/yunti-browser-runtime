  ...
  const tools = {
    ...
    yunti_select: {
      ...
      notes: [
        ...
        "Uid and selector option misses plus non-select targets now return structured selected=false diagnostics with code, matchMode, targetOption, availableValues/availableTexts when available, and recoveryHint.",
      ],
      recovery: [

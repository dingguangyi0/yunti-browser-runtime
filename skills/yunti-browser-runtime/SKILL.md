...
- Coordinate scroll results may include `coordinateTarget`, `scrollContainerFound`, and `coordinateScrollFallback: "document"`; when document fallback appears, observe again and prefer a fresh `scrollableContainers[]` uid for nested panels.
